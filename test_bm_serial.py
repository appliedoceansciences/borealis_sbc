...
while True:
    ...
    if now - last_send > 5:
        ...
        bm.spotter_tx(b"sensor12: 1234.56, binary_ok_too: \x00\x01\x02\x03\xff\xfe\xfd")
        bm.spotter_log("testmctest.log","Sensor 1: 1234.56. More detailed human-readable info for the SD card logs.",
        )
